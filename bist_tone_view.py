...
class bist_tone_view(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "bist_tone_view")
        ...
        self.iio_fmcomms2_source_0 = iio.fmcomms2_source_fc32('ip:169.254.34.234', [True, True, False, False], 32768)
        ...
        self.iio_fmcomms2_source_0.set_bbdc(False)
...
def main(top_block_cls=bist_tone_view, options=None):
